...
// Enums:
// Enums are not supported by Go. It is one of it's downsides.

// Iota:
// Go has a language feature, that when used with a type definition (and if you squint really hard), 
// kinda looks like an enum (but it's not). It's called iota.
